...
// with no joint limits the answers have wrap-around problem.
//
...
#include <kdl/chainiksolverpos_nr.hpp> // Newton-Raphson solver
...
bool Kinematics::init() {
    ...
    ik_solver_pos = new KDL::ChainIkSolverPos_NR(chain, *fk_solver, *ik_solver_vel, maxIterations, epsilon);
